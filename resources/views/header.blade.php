<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						...
						<li><a href=""><i class="fa fa-phone"></i> 0981 603 693</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						...
						@if(Auth::check())
						<li><a href="{{route('dang-ki')}}">Chào bạn : {{Auth::user()->full_name}}</a></li>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="" id="logo"><img src="sournce/assets/dest/images/logo.jpg" width="200px" alt=""></a>
				</div>
				<div class="pull-right beta-components space-left ov">
					<div class="space10">&nbsp;</div>
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="{{route('search')}}">
					        <input type="text" value="" name="sear" id="s" placeholder="Nhập từ khóa..." />
						...
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
									...
									<div class="media">
										<a class="pull-left" href="#"><img src="sournce/image/product/{{$product['item']['image']}}" alt=""></a>
