								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											...
											'themgiohang',$sp_new->id)}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="{{route('themgiohang',$sp_new->id)}}">Chi tiết <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{route('themgiohang',$sp_km->id)}}">Chi tiết <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
